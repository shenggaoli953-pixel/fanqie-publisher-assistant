...
class PublisherWindow(QMainWindow):
    ...
    def _build_short_story_page(self) -> QWidget:
        ...
        editor_scroll = QScrollArea(self.story_editor_panel)
        ...
        self.story_editor_layout = QVBoxLayout(self.story_editor)
        self.story_editor_layout.setContentsMargins(0, 0, 0, 0)
        self.story_editor_layout.setSpacing(20)

        heading = QLabel("短故事设置", self.story_editor)
        heading.setObjectName("pageTitle")
        self.story_editor_layout.addWidget(heading)
        self.story_editor_layout.addWidget(self._story_source_section(self.story_editor))
        self.story_editor_layout.addWidget(self._story_category_section(self.story_editor))
        self.story_preview_section = self._story_preview_section(self.story_editor)
        self.story_editor_layout.addWidget(self.story_preview_section)
        self.story_editor_layout.addStretch(1)
        editor_scroll.setWidget(self.story_editor)
        self.story_operation_section = self._story_operation_section(self.story_editor_panel)
        panel_layout.addWidget(editor_scroll, 1)
        panel_layout.addWidget(self.story_operation_section)

        self.story_splitter.addWidget(story_panel)
        self.story_splitter.addWidget(self.story_editor_panel)
    ...
    def _build_novel_page(self) -> QWidget:
        ...
        self.novel_editor_panel = QWidget(self.novel_splitter)
        panel_layout = QVBoxLayout(self.novel_editor_panel)
        panel_layout.setContentsMargins(14, 0, 0, 0)
        panel_layout.setSpacing(10)
        editor_scroll = QScrollArea(self.novel_editor_panel)
        editor_scroll.setWidgetResizable(True)
        editor_scroll.setFrameShape(QFrame.NoFrame)
        ...
        self.novel_operation_section = self._operation_section(self.novel_editor_panel)
        panel_layout.addWidget(editor_scroll, 1)
        panel_layout.addWidget(self.novel_operation_section)

        self.novel_splitter.addWidget(book_panel)
        self.novel_splitter.addWidget(self.novel_editor_panel)
