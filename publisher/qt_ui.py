...
class PublisherWindow(QMainWindow):
    ...
    def _build_short_story_page(self) -> QWidget:
        ...
        self.story_editor_layout.setContentsMargins(14, 0, 0, 0)
        ...
        self.story_operation_section = self._story_operation_section(self.story_editor)
        self.story_preview_section = self._story_preview_section(self.story_editor)
        self.story_editor_layout.addWidget(self.story_operation_section)
